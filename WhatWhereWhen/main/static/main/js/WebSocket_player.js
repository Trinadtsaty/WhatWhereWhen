...
//        console.log(data.users)
        if (data.type === 'redirect') {
            window.location.href = `/game/logout/${room_number}`
            ...
            //            console.log(user_host)
                        ...
                        if (!user.host) {
                            ...
                            const buttons_out = document.createElement('li');
                            buttons_out.className = 'tools_element';
                            buttons_out.textContent = 'Исключить';
                            buttons_out.onclick = () => sendOut(user.id);
                            spis_buttons.appendChild(buttons_out);
                        };
